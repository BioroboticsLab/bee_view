...
int main(int argc, char** argv) {
  if (argc > 1) {
    ...
    assert(true == TestLoadObj(argv[1], basepath));
	  ...
	  TestLoadObj("C:\\Users\\Tscho\\Documents\\Visual Studio 2017\\Projects\\ConsoleApplication2\\Debug\\panorama_skydome_triang_smooth.obj");
    // assert(true == TestLoadObj("cube.obj"));
    //assert(true == TestStreamLoadObj());
    //assert(true == TestLoadObj("D:\Documents\bachelorarbeit\raytracing\bee-eye-view\models\panorama_skydome_triang_smooth.obj", "", false));
  }
